 ...
 *
 *  file:  include\Controller\xxsim\ControllerModel.hpp
...
/* This file describes the model functions
 ...
 The model itself is the ControllerModel.cpp file
 */
...
namespace Controller
{
  ...
  class ControllerModel: virtual Submodel20sim
  {
    public:
