 ...
 *
 *  file:  src\xxsim\LinearSystemModel.cpp
...
namespace LinearSystem
{
  ...
  LinearSystemModel::~LinearSystemModel(void)
  {
    /* delete IO mappings */
  ...
  void LinearSystemModel::setupComputation()
  {
    start_time = 2.0;
    finish_time = 0;
    step_size = 0.01;
  ...
  bool LinearSystemModel::initializeComputation()
  {
  ...
  void LinearSystemModel::CopyInputsToVariables()
  {
  ...
  void LinearSystemModel::CopyVariablesToOutputs()
  {
   ...
   */
  inline void LinearSystemModel::CalculateInitial (void)
  {
   ...
   */
  inline void LinearSystemModel::CalculateStatic (void)
  {
   ...
   */
  inline void LinearSystemModel::CalculateInput (void)
  {
   ...
   */
  inline void LinearSystemModel::CalculateDynamic (void)
  {
    	/* x_dot = A * x + B * u; */
	R[0] = P[0] * s[0] + P[1] * V[0];
   ...
   */
  inline void LinearSystemModel::CalculateOutput (void)
  {
   ...
   * are performed
   */
  inline void LinearSystemModel::CalculateFinal (void)
  {
