    ...
    Recursion<CSPConstruct>()
{
  ...
  // Initialize channels
  myLoopConcontrol_out_to_displaycontrolChannel = new BufferedChannel<double, One2In, Out2One>(1, true, false);
  myLoopConoutput_to_PlantuChannel = new UnbufferedChannel<double, One2In, Out2One>();
  myPlanty_out_to_displayy_outChannel = new BufferedChannel<double, One2In, Out2One>(1, true, false);
  ...
  mySeqConpulse_out_to_displaypulseChannel = new BufferedChannel<double, One2In, Out2One>(1, true, false);
  ...
  myPlant = new LinearSystem::LinearSystem(myLoopConoutput_to_PlantuChannel, myPlanty_to_LoopConMVChannel, myPlanty_out_to_displayy_outChannel);
  ...
  mydisplay = new display::display(myLoopConcontrol_out_to_displaycontrolChannel, mySeqConpulse_out_to_displaypulseChannel, myPlanty_out_to_displayy_outChannel);
