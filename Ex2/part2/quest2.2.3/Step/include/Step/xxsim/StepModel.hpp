 ...
 *
 *  file:  include\Step\xxsim\StepModel.hpp
 *  subm:  StepModel
 *  model: ex2
 *  expmt: ex2
 *  date:  May 26, 2019
...
/* This file describes the model functions
 ...
 The model itself is the StepModel.cpp file
 */
...
namespace Step
{
  ...
  class StepModel: virtual Submodel20sim
  {
    public:
    ...
    /**
     * StepModel destructor
     */
    virtual ~StepModel(void);
