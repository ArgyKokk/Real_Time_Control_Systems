...
#define FMI2_FUNCTION_PREFIX ControllerPan_
#endif
 ...
 * memory
 */
const char* ControllerPan_URIToNativePath(xx_ModelInstance* model_instance, const char* uri)
{
								...
								fmi2Boolean loggingOn)
{
	...
	model_instance->resourceLocation = ControllerPan_URIToNativePath(model_instance, fmuResourceLocation);
					...
					fmi2Boolean noSetFMUStatePriorToCurrentPoint)
{
	...
	while (model_instance->time < (currentCommunicationPoint + communicationStepSize))
	{
		...
		if ( model_instance->m_use_finish_time && (model_instance->time >= model_instance->finish_time) )
		{
			...
			{
				model_instance->fmiCallbackFunctions->logger(NULL, "ControllerPan", fmi2Error, "error",
