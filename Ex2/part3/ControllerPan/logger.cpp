...
std::string FMILogger_ControllerPan::_fileNameSimulationLog;
std::string FMILogger_ControllerPan::_fileNameSystemLog;

FMILogger_ControllerPan::FMILogger_ControllerPan(void)
{
...
void FMILogger_ControllerPan::initLogger(std::string fileNameSimulationLog, std::string fileNameSystemLog,std::string measurementNames)
{
	// Set the variables
...
void FMILogger_ControllerPan::fmiLog(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status, fmi2String category, fmi2String message, ...)
{
...
void FMILogger_ControllerPan::saveMeasurementPoint(std::string measurementValues)
{
...
fmi2String FMILogger_ControllerPan::enumStatusToString(fmi2Status status)
{
