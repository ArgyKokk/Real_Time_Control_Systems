...
#define FMI2_FUNCTION_PREFIX JoyStick_
#endif
 ...
 * memory
 */
const char* JoyStick_URIToNativePath(xx_ModelInstance* model_instance, const char* uri)
{
								...
								fmi2Boolean loggingOn)
{
	...
	model_instance->resourceLocation = JoyStick_URIToNativePath(model_instance, fmuResourceLocation);
					...
					fmi2Boolean noSetFMUStatePriorToCurrentPoint)
{
	...
	while (model_instance->time < (currentCommunicationPoint + communicationStepSize))
	{
		...
		if ( model_instance->m_use_finish_time && (model_instance->time >= model_instance->finish_time) )
		{
			...
			{
				model_instance->fmiCallbackFunctions->logger(NULL, "JoyStick", fmi2Error, "error",
