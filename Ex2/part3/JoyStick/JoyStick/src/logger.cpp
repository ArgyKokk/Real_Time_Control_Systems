...
std::string FMILogger_JoyStick::_fileNameSimulationLog;
std::string FMILogger_JoyStick::_fileNameSystemLog;

FMILogger_JoyStick::FMILogger_JoyStick(void)
{
...
void FMILogger_JoyStick::initLogger(std::string fileNameSimulationLog, std::string fileNameSystemLog,std::string measurementNames)
{
	// Set the variables
...
void FMILogger_JoyStick::fmiLog(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status, fmi2String category, fmi2String message, ...)
{
...
void FMILogger_JoyStick::saveMeasurementPoint(std::string measurementValues)
{
...
fmi2String FMILogger_JoyStick::enumStatusToString(fmi2Status status)
{
