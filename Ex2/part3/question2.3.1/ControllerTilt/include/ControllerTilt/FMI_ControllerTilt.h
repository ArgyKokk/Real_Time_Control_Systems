/**
 * Header file for the FMI_ControllerTilt model
...
class FMI_ControllerTilt : public CodeBlock
{

public:
  // Define constructor and destructor
  FMI_ControllerTilt(double &SetPointTilt, double &measIO, double &steerIO);
  virtual ~FMI_ControllerTilt();
...
FMILogger_ControllerTilt *logger = new FMILogger_ControllerTilt();

// functions for the FMU
fmi2CallbackFunctions cbf = {FMILogger_ControllerTilt::fmiLog,calloc,free,NULL,NULL};
