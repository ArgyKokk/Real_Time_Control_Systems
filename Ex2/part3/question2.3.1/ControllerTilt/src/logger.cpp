...
std::string FMILogger_ControllerTilt::_fileNameSimulationLog;
std::string FMILogger_ControllerTilt::_fileNameSystemLog;

FMILogger_ControllerTilt::FMILogger_ControllerTilt(void)
{
...
void FMILogger_ControllerTilt::initLogger(std::string fileNameSimulationLog, std::string fileNameSystemLog,std::string measurementNames)
{
	// Set the variables
...
void FMILogger_ControllerTilt::fmiLog(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status, fmi2String category, fmi2String message, ...)
{
...
void FMILogger_ControllerTilt::saveMeasurementPoint(std::string measurementValues)
{
...
fmi2String FMILogger_ControllerTilt::enumStatusToString(fmi2Status status)
{
