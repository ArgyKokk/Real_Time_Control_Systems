 ...
 *
 *  file:  include\ControllerTilt\xxsim\ControllerTiltModel.hpp
...
/* This file describes the model functions
 ...
 The model itself is the ControllerTiltModel.cpp file
 */
...
namespace ControllerTilt
{
  ...
  class ControllerTiltModel: virtual Submodel20sim
  {
    public:

    /**
     * ControllerTiltModel constructor
     */
    ControllerTiltModel();

    /**
     * ControllerTiltModel destructor
     */
    virtual ~ControllerTiltModel(void);
