 ...
 *
 *  file:  include\ControllerPan\xxsim\ControllerPanModel.hpp
...
/* This file describes the model functions
 ...
 The model itself is the ControllerPanModel.cpp file
 */
...
namespace ControllerPan
{
  ...
  class ControllerPanModel: virtual Submodel20sim
  {
    public:

    /**
     * ControllerPanModel constructor
     */
    ControllerPanModel();

    /**
     * ControllerPanModel destructor
     */
    virtual ~ControllerPanModel(void);
